(function ($) {
    ...
    var showResult = function (data) {
        var list = $("#data");
        var htmlTemplate = '<li class="list-group-item"><a href="#" data-id="{Value}" data-text="{Name}">{Name}</a></li>';
        var array = data.EasySearch;
        if (array) {
            list.empty();
    ...
    var queryData = function () {
        ...
        var url = "../library/WebModuleContentPage.tkx?Source=EasySearch&useSource=true";
        $.ajax({
            type: "post",
            url: url,
