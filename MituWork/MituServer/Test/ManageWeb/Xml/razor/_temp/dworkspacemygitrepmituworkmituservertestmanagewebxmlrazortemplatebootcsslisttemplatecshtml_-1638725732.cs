...
namespace YJC.Toolkit.Razor.Dynamic {
    ...
    public class dworkspacemygitrepmituworkmituservertestmanagewebxmlrazortemplatebootcsslisttemplatecshtml : YJC.Toolkit.Razor.NormalListTemplate {
        
#line hidden
        
        public dworkspacemygitrepmituworkmituservertestmanagewebxmlrazortemplatebootcsslisttemplatecshtml() {
        }
...
WriteAttribute("src", Tuple.Create(" src=\"", 2470), Tuple.Create("\"", 2550)
, Tuple.Create(Tuple.Create("", 2476), Tuple.Create<System.Object, System.Int32>("toolkitjs/v5/toolkit/coreT/toolkit.normallist.js?v=1".AppVirutalPath()
, 2476), false)
);
