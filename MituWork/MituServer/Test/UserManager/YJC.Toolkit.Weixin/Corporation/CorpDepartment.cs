...
{
    [TypeScheme(Author = "YJC", CreateDate = "2014-11-20", Description = "微信企业号的组织部门信息")]
    public class CorpDepartment : WeixinResult, IEntity, IRegName, ITreeNode, IDecoderItem, IOrder
    {
        internal CorpDepartment()
        {
        }
