...
** This particular table is actually a variable you are declaring on the fly.
*/
...
/* Now that you have your table variable, you're ready to populate it with data 
** from your SELECT statement. Note that you could just as easily insert the 
