...
(function ($) {
    ...
    Toolkit.data._getCustomCtrl = function (field, ctrl, result) {
        ...
        result.value["GetValue"] = elm.attr("data-getValue");
        result.value["SetValue"] = elm.attr("data-setValue");
    };
    ...
    Toolkit.data._getElementById = function (field) {
        ...
        switch (field.Type) {
            ...
            case "Custom":
                ...
                _getCustomCtrl(field, ctrl, resultRef);
    ...
    Toolkit.data._defaultProcess = function (message) {
        var retValue;
            ...
            if (result === "Success") {
                ...
                if (data.AlertMessage && data.AlertMessage != "") {
                    if (Toolkit.page.isDlgWin)
                        ...
                        needProcess = false;
                        Toolkit.page.alert(data.AlertMessage, function () { Toolkit.data._defaultProcess(message); });
                    }
                }
                if (needProcess)
                    Toolkit.data._defaultProcess(message);
            }
