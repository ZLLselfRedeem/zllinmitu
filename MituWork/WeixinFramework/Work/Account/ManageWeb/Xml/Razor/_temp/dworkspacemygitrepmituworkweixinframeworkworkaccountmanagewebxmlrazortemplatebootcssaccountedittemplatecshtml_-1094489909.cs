...
WriteAttribute("src", Tuple.Create(" src=\"", 1812), Tuple.Create("\"", 1882)
, Tuple.Create(Tuple.Create("", 1818), Tuple.Create<System.Object, System.Int32>("toolkitjs/v5/toolkit/coreT/toolkit.edit.js".AppVirutalPath()
, 1818), false)
);
