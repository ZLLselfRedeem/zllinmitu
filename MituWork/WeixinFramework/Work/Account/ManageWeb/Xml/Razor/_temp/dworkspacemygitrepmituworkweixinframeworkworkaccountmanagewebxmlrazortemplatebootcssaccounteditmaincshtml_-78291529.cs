...
WriteAttribute("action", Tuple.Create(" action=\"", 2069), Tuple.Create("\"", 2106)
, Tuple.Create(Tuple.Create("", 2078), Tuple.Create<System.Object, System.Int32>(ViewBag.PageData.FormAction
, 2078), false)
);
...
WriteAttribute("value", Tuple.Create(" value=\"", 3678), Tuple.Create("\"", 3705)
, Tuple.Create(Tuple.Create("", 3686), Tuple.Create<System.Object, System.Int32>(rptInfo.ReportType
, 3686), false)
);
...
WriteAttribute("value", Tuple.Create(" value=\"", 3754), Tuple.Create("\"", 3778)
, Tuple.Create(Tuple.Create("", 3762), Tuple.Create<System.Object, System.Int32>(rptInfo.Company
, 3762), false)
);
...
WriteAttribute("value", Tuple.Create(" value=\"", 3828), Tuple.Create("\"", 3853)
, Tuple.Create(Tuple.Create("", 3836), Tuple.Create<System.Object, System.Int32>(rptInfo.ReportId
, 3836), false)
);

WriteLiteral(">\r\n        </div>\r\n    </div>\r\n    <br />\r\n    <div");

WriteAttribute("id", Tuple.Create(" id=\"", 3905), Tuple.Create("\"", 3926)
, Tuple.Create(Tuple.Create("", 3910), Tuple.Create<System.Object, System.Int32>(table.TableName
, 3910), false)
);

WriteAttribute("class", Tuple.Create(" class=\"", 3927), Tuple.Create("\"", 4022)
, Tuple.Create(Tuple.Create("", 3935), Tuple.Create<System.Object, System.Int32>(HtmlUtil.MergeClass("tk-datatable table-row", "column" + table.ColumnCount.ToString())
, 3935), false)
);
...
WriteAttribute("class", Tuple.Create(" class=\"", 4594), Tuple.Create("\"", 4639)
, Tuple.Create(Tuple.Create("", 4602), Tuple.Create<System.Object, System.Int32>("col-sm-" + columnWidth.ToString()
, 4602), false)
);
...
WriteLiteral(">");
                                                        ...
                                                        Write(field.Control(mainObject, null, true));
