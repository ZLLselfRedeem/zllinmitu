...
WriteAttribute("value", Tuple.Create(" value=\"", 3789), Tuple.Create("\"", 3807)
                                                                             , Tuple.Create(Tuple.Create("", 3797), Tuple.Create<System.Object, System.Int32>(dateValue
, 3797), false)
);
...
WriteAttribute("value", Tuple.Create(" value=\"", 4336), Tuple.Create("\"", 4363)
, Tuple.Create(Tuple.Create("", 4344), Tuple.Create<System.Object, System.Int32>(rptInfo.ReportName
, 4344), false)
);
...
WriteAttribute("value", Tuple.Create(" value=\"", 4416), Tuple.Create("\"", 4440)
, Tuple.Create(Tuple.Create("", 4424), Tuple.Create<System.Object, System.Int32>(rptInfo.Company
, 4424), false)
);
...
WriteAttribute("value", Tuple.Create(" value=\"", 4494), Tuple.Create("\"", 4519)
, Tuple.Create(Tuple.Create("", 4502), Tuple.Create<System.Object, System.Int32>(rptInfo.ReportId
, 4502), false)
);

WriteLiteral(">\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <br />\r\n    <div");

WriteAttribute("id", Tuple.Create(" id=\"", 4591), Tuple.Create("\"", 4612)
, Tuple.Create(Tuple.Create("", 4596), Tuple.Create<System.Object, System.Int32>(table.TableName
, 4596), false)
);

WriteAttribute("class", Tuple.Create(" class=\"", 4613), Tuple.Create("\"", 4708)
, Tuple.Create(Tuple.Create("", 4621), Tuple.Create<System.Object, System.Int32>(HtmlUtil.MergeClass("tk-datatable table-row", "column" + table.ColumnCount.ToString())
, 4621), false)
);
...
WriteAttribute("class", Tuple.Create(" class=\"", 5280), Tuple.Create("\"", 5325)
, Tuple.Create(Tuple.Create("", 5288), Tuple.Create<System.Object, System.Int32>("col-sm-" + columnWidth.ToString()
, 5288), false)
);
