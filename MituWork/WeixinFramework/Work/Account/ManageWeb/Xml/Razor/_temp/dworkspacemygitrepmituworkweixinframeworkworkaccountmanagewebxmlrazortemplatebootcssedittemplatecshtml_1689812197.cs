...
namespace YJC.Toolkit.Razor.Dynamic {
    ...
    public class dworkspacemygitrepmituworkweixinframeworkworkaccountmanagewebxmlrazortemplatebootcssedittemplatecshtml : YJC.Toolkit.Razor.NormalEditTemplate {
        
#line hidden
        
        public dworkspacemygitrepmituworkweixinframeworkworkaccountmanagewebxmlrazortemplatebootcssedittemplatecshtml() {
        }
...
WriteAttribute("src", Tuple.Create(" src=\"", 1519), Tuple.Create("\"", 1589)
, Tuple.Create(Tuple.Create("", 1525), Tuple.Create<System.Object, System.Int32>("toolkitjs/v5/toolkit/coreT/toolkit.edit.js".AppVirutalPath()
, 1525), false)
);
