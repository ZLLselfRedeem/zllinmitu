...
namespace TestData
{
    ...
    {
        internal static readonly ExcelContentFormat DefaultHead = new ExcelContentFormat(true, Alignment.Center);
        internal static readonly ExcelContentFormat DefaultContent = new ExcelContentFormat(false, Alignment.Right);
