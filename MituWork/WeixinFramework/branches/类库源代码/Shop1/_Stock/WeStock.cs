...
namespace YJC.Toolkit.Weixin.Shop
{
    ...
    {
        public WeStock(ProductProperty[] skuInfo, int quantity, string productId)
        {
            TkDebug.AssertArgumentNullOrEmpty(productId, "productId", null);
            TkDebug.AssertArgumentNull(skuInfo, "skuInfo", null);

            SkuInfo = new List<ProductProperty>(skuInfo);
            ProductId = productId;
            Quantity = quantity;
        }
        ...
        public List<ProductProperty> SkuInfo { get; private set; }
