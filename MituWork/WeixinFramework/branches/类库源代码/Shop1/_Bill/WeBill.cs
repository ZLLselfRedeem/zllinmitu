...
namespace YJC.Toolkit.Weixin.Shop
{
    public class WeBill : WeixinResult
    {
        ...
        public static WeixinResult SetNoDelivery(string orderId, bool needDelivery)
        {
            TkDebug.AssertArgumentNullOrEmpty(orderId, "orderId", null);
            ...
            if (!needDelivery)
            {
                ...
                result = WeUtil.PostToUri(url, request.WriteJson(), new WeixinResult());
            }
            return result;
        }

        public static WeixinResult SetDelivery(string orderId, WeDeliveryCompany deliveryCompany,
            string deliveryTrackNo, bool isOthers, bool needDelivery)
        {
            TkDebug.AssertArgumentNullOrEmpty(orderId, "orderId", null);
